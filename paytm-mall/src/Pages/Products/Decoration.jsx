      ...
      <Flex m="0" px="2%">
        <Box w="18%" m={0}>
          ...
          <VStack mb="20px" alignItems="flex-start">
            ...
            <Checkbox colorScheme="green" value={"4.5"} onChange={handleRating}>
              2⋆⋆ and above
            </Checkbox>
            <Checkbox colorScheme="green" value={"4.6"} onChange={handleRating}>
              3⋆⋆⋆ and above
            </Checkbox>
            <Checkbox colorScheme="green" value={"4.7"} onChange={handleRating}>
              4⋆⋆⋆⋆ and above
            </Checkbox>
          </VStack>
        </Box>
